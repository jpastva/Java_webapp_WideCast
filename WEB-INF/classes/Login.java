...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		//user details are validated using Registration table in database 
		//if the database contains username and password, user will be directed to home page
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option>"
					+ "<option value='manager'>Store Manager</option><option value='support'>Account Specialist</option>"
					+ "<option value='technician'>Technical Support Specialist</option></select>"
				+ "</td></tr><tr><td></td><td>"
